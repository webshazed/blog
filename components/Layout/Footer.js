            ...
            <div className={`${styles.content} container`}>
                ...
                <div className={styles.grid}>
                    ...
                    <div className={styles.brand}>
                        <Link href="/" className={styles.logo}>Evergreen<span>.</span></Link>
                        <p className={styles.tagline}>
                            Stories & insights on design, technology, and the slow art of living well.
                        </p>
                        <div className={styles.socials}>
                            ...
                            <a href="/rss" className={styles.socialIcon} aria-label="RSS">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    {/* Categories */}
                    <div className={styles.column}>
                        <h4 className={styles.columnTitle}>Topics</h4>
                        <ul className={styles.linkList}>
                ...
                <div className={styles.bottom}>
                    <p className={styles.copyright}>
                        © {new Date().getFullYear()} Evergreen Blog. All rights reserved.
                    </p>
